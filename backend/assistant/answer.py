...
normic_model = './models/models--nomic-ai--nomic-embed-text-v1.5/snapshots/e5cf08aadaa33385f5990def41f7a23405aec398'
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", default="smollm2:360m", help="Ollama model to use (default: qwen3:0.6b)")
